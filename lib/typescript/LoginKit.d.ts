 ...
 * access to others.
 */
export declare enum UserDataScopes {
    /**
...
export declare type LoginKitType = {
    /**
     ...
     */
    fetchUserData(query: string, variables: Record<string, any> | null): Promise<UserData>;
    /**
...
declare const LoginKit: LoginKitType;
export { LoginKit };
